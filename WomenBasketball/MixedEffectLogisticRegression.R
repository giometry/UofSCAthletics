...
setwd("C:/Users/giova/Documents/School/Classes/Spring 2025/Capstone Project/WomenBasketball2024")

# Load data
dat <- read.csv("cleaned_women_basketball_2024.csv", stringsAsFactors = TRUE)
dat <- na.omit(dat)
